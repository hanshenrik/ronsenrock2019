...
view model =
    div [ class "wrapper" ]
        ...
        , header [ id "header" ]
            [ div [ id "logo" ] []
            , h2 [ class "date" ] [ text "5. - 8. juli 2018" ]
            ]
        , div [ class "main" ]
            [ div [ class "section" ]
            ...
            , div [ class "section" ]
                [ table [ class "program" ]
                    [ tbody []
                        ...
                        , tr []
                            [ td [ colspan 2, style [ ( "font-size", "1rem" ), ( "max-width", "50px" ) ] ] [ text "Det blir DJ utpå gressmatta, og vi holder vår årlige nonchalante volleyballturnering. Med lukta ta grillkøl i nasan rocker vi den første natten inn togetha!" ]
                            ]
                        ...
                        , tr []
                            [ td [ class "time" ] [ text "11:00" ]
                            , td [] [ text "Ryddeyoga m/morgenkaffe" ]
                            ]
                        , tr []
                            [ td [ class "time" ] [ text "12:00" ]
