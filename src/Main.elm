            ...
            , div [ class "section artists" ]
                ...
                , div [ class "artists-list" ]
                    ...
                    , div [ class "artist-bio" ]
                        ...
                        , p [] [ text "Forgetaboutit er endelig tilbake med ny EP! 'The Resurrection Of Everything' er ute fysisk og digitalt på Big Day Records nå! Ep'n har fått god omtale og singlene 'Warning' og 'Bring It All Toghether' blir stadig vekk spilt på radio." ]
                        , p [] [ text "Sjekk ut EP-en: ", a [ href "https://goo.gl/BgCM2M", target "_blank" ] [ text "The Resurrection of Everything" ] ]
