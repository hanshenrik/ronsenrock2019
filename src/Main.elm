        ...
        , div [ class "main" ]
            ...
            , div [ class "section directions" ]
                [ div []
                    ...
                    , h4 [] [ text "Med tog" ]
                    , p []
                        [ text "I og med at Eidsvoll er Vy sin navle, er det mange togavganger som stopper på Eidsvoll stasjon. Sjekk "
                        , a [ href "https://vy.no", target "_blank" ] [ text "vy.no" ]
                        , text " for detaljer."
                        ]
                    ...
                    , p []
                        ...
                        , a [ href "https://www.facebook.com/events/1276322845893719", target "_blank" ] [ text "Facebook-eventet" ]
                        , text "."
                        ]
                    ]
                , div [ id "map" ] []
