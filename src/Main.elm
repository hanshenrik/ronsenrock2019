            ...
            , div [ class "section artists" ]
                ...
                , div [ class "artists-list" ]
                    ...
                    , div [ class "artist-bio" ]
                        ...
                        , p [] [ text "Sjekk de ut på ", a [ href "https://soundcloud.com/astralplane-44023896?fbclid=IwAR005Ma6MJRZyYkWULU8vnjhCHXTs6_vTJll2BUDZ9P2uFSRiDP6J98XwQ0", target "_blank" ] [ text "Soundcloud" ], text "." ]
                        ]
                    ...
                    , div [ class "artist-bio" ]
                        ...
                        , p [] [ text "Sjekk de ut på ", a [ href "https://open.spotify.com/artist/4yvjUqvsYYCd0zwSQ1q4LF?si=sEacXLhURgWhwzvyRGNVUA", target "_blank" ] [ text "Spotify" ], text "." ]
                        ]
                    ...
                    , div [ class "artist-bio" ]
                        ...
                        , p [] [ text "Sjekk de ut på ", a [ href "https://open.spotify.com/artist/6hfaqCCJQ81CwbFderSq5m?si=SlQLTGpiQsaN03xW4Vu-MA", target "_blank" ] [ text "Spotify" ], text "." ]
                        ]
