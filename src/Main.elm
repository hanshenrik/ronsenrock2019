...
view model =
    div [ class "wrapper" ]
        ...
        , div [ class "main" ]
            ...
            , div [ class "divider-img-wrapper-full", style [( "background-image", "url('/images/stemning.jpg')" )] ]
            ...
            , div [ class "section" ]
                ...
                , div [ class "divider-img-wrapper", style [( "background-image", "url('/images/lydmann-tk.jpg')" )] ]
                    [ div [ class "attribution-core" ] [ text "RønsenROCKs elskede lydmann, Håkon", br [] [], text "📷 Thomas Kvehaugen"] ]
            ...
            , div [ class "divider-img-wrapper-full", style [( "background-image", "url('/images/bacon.jpg')" )] ]
                [ div [ class "attribution" ] [ text "Thomas Kvehaugen"] ]
            , div [ class "section" ]
            ...
            , div [ class "divider-img-wrapper-full", style [( "background-image", "url('/images/sofa.jpg')" )] ]
                [ div [ class "attribution" ] [ text "Thomas Kvehaugen"] ]
            ]
