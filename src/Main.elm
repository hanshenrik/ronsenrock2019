            ...
            , div [ class "section artists" ]
                ...
                , div [ class "artists-list" ]
                    ...
                    , div [ class "artist-bio" ]
                        [ p [] [ text "Med omtalelser som '(...) solos and instrumentation that could make Jimmy Page blush.' (James Davenport, Punktastic, 17.03.2016), 'Det er lite annet å si enn at om du ikke kommer i godt humør av dette er du en av de døveste menneskene i verden.' (Råkkfolk, 14.12.2017) og 'Blir i godt humør hver gang jeg hører på' (Balladepodden, 20.12.2017) har rockebandet Sorgen rocket seg inn i hjertene til et ekslusivt lite knippe mennesker i Oslo-området. Nå sikter de på å rekke ut til et større knippe mennesker i Oslo-området, og spiller på AyeAyeClub!" ]
                    ...
                    , div [ class "artist-bio" ]
                        ...
                        , p [] [ text "Vi starter opp hele festivalen og ønsker at du er med å sparke i gang årets festival. Så sjekk oss ut!" ]
                        ]
                    ...
                    , div [ class "artist-bio" ]
                        [ p [] [ text "Vi gleder oss stort over å annonsere at Inglorious Retards kommer tilbake til RønsenROCK for fjerde år på rad! De foregående konsertene signert retardsa har av mange blitt regnet som de beste på RønsenROCK, og det er vanskelig å se for seg at årets gig skal bli noe dårligere." ]
                    ...
                    , div [ class "artist-bio" ]
                        ...
                        , p [] [ text "Henrik Høibraaten (gitar, vokal), Martin Haugen (bass), Nicolas Palacios (synth, gitar), Ole Mathias Sommerfelt (trommer)" ]
                        ]
                    ...
                    , div [ class "artist-bio" ]
                        [ p [] [ text "Bucktooth Dan er en gitarist og sanger tidligere og fortsatt kjent for å være det samme i punkbandet Inglorious Retards." ]
