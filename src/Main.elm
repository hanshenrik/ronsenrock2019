    ...
    div [ class "wrapper" ]
        ...
        , div [ class "main" ]
            ...
            , div [ class "divider-img-wrapper-full", style [ ( "background-image", "url('/images/bacon-tk.jpg')" ) ] ]
                [ div [ class "attribution" ] [ text "Thomas Kvehaugen" ] ]
            , div [ class "section" ]
                [ h1 [] [ text "Spille på RønsenROCK?" ]
                , p [] [ text "Ønsker du å spille på RønsenROCK 2019? Kult! Send litt informasjon om deg eller bandet til ", a [ href "mailto:booking@rønsenrock.no", target "_blank" ] [ text "booking@rønsenrock.no" ], text " innen ", h5 [ class "inline" ] [ text "01.03.2019" ], text ". Legg gjerne ved linker til Spotify, Facebook eller andre steder vi kan høre dere. Vi har hatt veldig mange ulike typer artister og ønsker å fortsette med et variert musikalsk uttrykk. Så ikke nøl med å ta kontakt! Vi håper på å høre fra deg!" ]
                , p [] [ text "mvh", br [] [], text "Festivalstyret" ]
                ]
            , div [ class "divider-img-wrapper-full", style [ ( "background-image", "url('/images/jokk-tk.jpg')" ) ] ]
                [ div [ class "attribution" ] [ text "Thomas Kvehaugen" ] ]
            , div [ class "section artists" ]
                [ h1 [] [ text "Artististorikk" ]
            ...
            , div [ class "section" ]
                ...
                , p [] [ text "RønsenROCK finansieres etter spleiselagprinsippet. Derfor oppfordrer vi alle til å bidra med 150,- per dag eller 250,- for festivalpass ved inngangen. I bytte mot bidraget får du et stilig festivalarmbånd. Men la det være klart: RønsenROCK gjør ikke forskjell på fattig og rik. Her er alle velkomne. Er du pengelens, kan du heller bidra med rock, roll og generelt god festivalstemning." ]
                , p [] [ h5 [ class "inline" ] [ text "150,-" ], text " per dag eller ", h5 [ class "inline" ] [ text "250,-" ], text " for hele festivalen. Kontant, kort eller Vipps." ]
