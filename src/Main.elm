        ...
        , div [ class "main" ]
            ...
            , div [ class "section" ]
                [ div [ class "program" ]
                    ...
                    , div [ class "event-info" ]
                        [ img [ src "/images/tautrekking2-tk.jpg" ] []
            ...
            , div [ class "section artists" ]
                ...
                , div [ class "artists-list" ]
                    ...
                    , div [ class "artist", style [ ( "background-image", "url('/images/artists/the-loop-brothers.jpg')" ) ] ]
                        [ h3 [] [ text "The Loop Brothers" ]
                        , div [ class "show-more-button" ] []
                        ]
                    , div [ class "artist-bio" ]
                        [ p [] [ h5 [ class "inline" ] [ text "The Loop Brothers" ], text " ..." ]
                        , p [] [ text "..." ]
                        ]
