        ...
        , div [ class "main" ]
            ...
            , div [ class "section artists" ]
                ...
                , div [ class "artists-list" ]
                    ...
                    , div [ class "artist-bio" ]
                        [ p [] [ text "Rock kommer i mange former og slam poetry kan vi vel regne som en av dem hvis vi vrir litt på begrepet. ", h5 [ class "inline" ] [ text "Marius Abrahamsen" ], text " kommer i år med sin poetiske tunge og kanskje klarer han å røre flere enn ", a [ href "https://www.tv2.no/v/1141202/", target "_blank" ] [ text "Bjarne Brønboe" ], text "." ]
                        ]
                    ...
                    , div [ class "artist-bio" ]
                        ...
                        , p [] [ text "Bandets første utgivelse «Compete Or Die EP» kom høsten 2015, og siden det har bandet spilt land og strand rundt med band som Millencolin, Skambankt, Ondt Blod og Pappasaft. Nå er bandet klare med ny musikk og gir i 2017 ut sin andre EP!" ]
                        , p [] [ text "Forgetaboutit kombinerer catchy refrenger og blodtight spilling til en energibombe av en liveopplevelse du ikke klarer stå stille til! Sing along, jump along and fucking FORGETABOUTIT!" ]
                        , p [] [ a [ href "https://www.youtube.com/watch?v=jibJ9ErzC74", target "_blank" ] [ text "Compete or Die" ] ]
                        ]
                    ]
